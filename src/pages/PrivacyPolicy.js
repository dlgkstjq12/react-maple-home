    ...
    return (
        <div className="pri-text-container">
            <div className="pri-text-box">
                <h1 className="large-custom-font">개인정보 처리방침</h1>
                <p>
                    <strong>메이플-파이터</strong>(이하 "서비스")는 이용자의 개인정보를 중요하게 생각하며, 「개인정보 보호법」 등 관련 법령을 준수합니다. <br/> 
                    본 개인정보 처리방침은 서비스가 이용자의 개인정보를 어떻게 수집, 이용, 보관, 파기하며 어떤 권리가 보장되는지를 설명합니다.
                </p>
                <h2 className="large-custom-font">1. 수집하는 개인정보 항목</h2>
                ...
                <h2 className="large-custom-font">2. 개인정보 수집 방법</h2>
                <ul className="list-disc list-inside mb-4">
                ...
                <h2 className="large-custom-font">3. 개인정보의 이용 목적</h2>
                <ul className="list-disc list-inside mb-4">
                ...
                <h2 className="large-custom-font">4. 보유 및 이용 기간</h2>
                ...
                <h2 className="large-custom-font">5. 제3자 제공</h2>
                <p className="mb-4">이용자의 동의 없이는 개인정보를 외부에 제공하지 않으며, 법령에 따른 경우만 예외로 합니다.</p>

                <h2 className="large-custom-font">6. 위탁 처리</h2>
                <p className="mb-4">현재 위탁 업체는 없으며, 필요 시 고지 후 동의받습니다.</p>

                <h2 className="large-custom-font">7. 이용자의 권리</h2>
                <ul className="list-disc list-inside mb-4">
                    <li>개인정보 열람, 정정, 삭제, 처리 정지 요청 가능</li>
                    <li>계정 설정 또는 고객센터를 통해 요청 가능</li>
                </ul>

                <h2 className="large-custom-font">8. 파기 절차 및 방법</h2>
                <ul className="list-disc list-inside mb-4">
                    <li>전자 파일: 복구 불가능한 방법으로 삭제</li>
                    <li>인쇄물: 파쇄 또는 소각</li>
                </ul>

                <h2 className="large-custom-font">9. 개인정보 보호 대책</h2>
                <ul className="list-disc list-inside mb-4">
                    <li>비밀번호 암호화 저장</li>
                ...
                <h2 className="large-custom-font">10. 개인정보 보호 책임자</h2>
                <p className="mb-4">
                    이름: 스카니아@도끼질의참맛<br />
                ...
                <h2 className="large-custom-font">11. 고지의 의무</h2>
                <p className="mb-4">
